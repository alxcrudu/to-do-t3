...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="relative z-0 h-screen w-screen bg-waves-haikei bg-cover bg-bottom px-6">
        <Navbar />
        {sessionData ? (
          <>
            <div className="mt-12 flex flex-col items-center gap-2">
              ...
              >
                ...
                />
                <input
                  className="btn-primary btn-sm btn ml-2 h-full border-none font-light normal-case shadow-xl"
                  type="submit"
                  value="Add task"
                />
              </form>
            ...
            <div className="mt-12 flex flex-col items-center gap-6">
              {tasks?.map((task, i) => (
                <div
                  key={i}
                  className="card w-1/2 bg-primary bg-opacity-50 shadow-xl"
                >
